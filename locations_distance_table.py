...
address_to_index = {location: index for index, location in enumerate(locations)}

#print(f"address_to_index: {address_to_index}")

#print("Address to index mapping:", address_to_index)